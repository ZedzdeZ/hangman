var Hangman = (function () {
    ...
    Hangman.prototype.guess = function (letter) {
        ...
        if (this.WORD.indexOf(letter) < 0) {
            ...
            if (wo.includes(this.WORD) == false ) {
                count ++;
                wo.push(this.WORD)
                if (count == 7){
                    win.play();
                    this.showElementByIdWithContent(this.elId + "_end", "You made it!<br/>The word was: " + this.WORD + ". <h1>Your won (score = 7 / 7), go ahead and tell us if you're the first.</h1>");
                }
                else {
                    cong.play();
                    this.showElementByIdWithContent(this.elId + "_end", "You made it!<br/>The word was: " + this.WORD + ". Your score now is " + count + " / 7 .");
                }
            }
            else {
                this.showElementByIdWithContent(this.elId + "_end", "Just refreshing your memory, you got this word before.");
            }
            this.STOPPED = true;
        }
    };
